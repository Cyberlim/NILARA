...
import { Image as ImageIcon, MousePointer, Percent, PauseCircle } from "lucide-react";
...
export default function BannersKPIs({ onCardClick }) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      {[].map((kpi) => {
        const Icon = iconMap[kpi.icon] || ImageIcon;
        return (
          <div 
            key={kpi.id} 
